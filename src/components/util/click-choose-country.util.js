...
export function clickChooseCountry(element) {
    ...
    element.addEventListener("click", (e) => {
        if (e.target.closest(".country-list-country-wrapper")) {
            ...
            event.detail.countryFullName = e.target.closest(".country-list-country-wrapper").getAttribute("data-countryFull");
            ...
            event.detail.countryFullName = e.target.closest(".global-table-table-item").getAttribute("data-countryFull");
            event.detail.countryClick = !countryClick;
            countryClick = !countryClick;
